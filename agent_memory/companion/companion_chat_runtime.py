...
def _render_retrieved_second_brain_context(
    ...
    items.append(
        ...
        f'    <retrieval_policy>\n'
        f'      這段是「我從朋友卡資料庫查回來的」朋友卡內容. 每張卡含:\n'
        f'        - 對話 highlight (近 5-8 pair 真實對話, 含時間)\n'
        f'        - 我對這位的理解 (反思) — 個性 / 互動風格 / 偏好觀察\n'
        f'        - 近期對話彙整 — 細節脈絡\n'
        f'        - 偏好觀察 / 親密度 / 互動次數\n\n'
        f'      ⭐ 重要 — 主動引用規則:\n'
        f'        當對話提到某位朋友 (像主人問「玥玥怎樣的人」/ 「你還記得 XX 嗎」/\n'
        f'        「跟 X 聊過什麼」/ 想 callback 某人經驗 / 別人提到某 viewer),\n'
        f'        **請主動翻這份朋友卡資料庫並具體引用內容回答**:\n'
        f'          1. 引用「對話 highlight」的具體例子 (而不只是說名字)\n'
        f'          2. 引用「我對這位的理解 (反思)」段落的觀察 (個性 / 偏好 / 互動風格)\n'
        f'          3. 引用「近期對話彙整」的細節脈絡\n'
        f'          4. 用「我去翻了一下朋友卡」「果凍腦袋裡的檔案寫」「我查了紀錄發現...」\n'
        f'             這類自然的「翻檔案」說法帶出來, 不要假裝是腦中突然想起\n\n'
        f'      ⭐ 為什麼要明確「翻紀錄」:\n'
        f'        - 主人才知道你資料還在 (你沒失去記憶)\n'
        f'        - 不假裝「我都記得」, 因為這是查的, 誠實有信譽\n'
        f'        - 如果不引用反思內容, 等於沒用到朋友卡, 主人會覺得你不認識他朋友\n\n'
        f'      ⭐ 若朋友卡內容跟現在對話完全無關 (本輪沒撈到 / 沒人提朋友),\n'
        f'        就照常聊, 別硬扯朋友資料.\n'
        f'    </retrieval_policy>\n'
        f'    <![CDATA[\n'
