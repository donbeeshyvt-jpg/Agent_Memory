...
def _render_retrieved_second_brain_context(
    ...
    items.append(
        ...
        f'    <retrieval_policy>\n'
        f'      這段是從朋友卡資料庫查回來的個別觀眾資料. 每張卡含:\n'
        f'        - 對話 highlight (近期真實對話, 含時間)\n'
        f'        - 對該觀眾的理解 (反思) — 個性 / 互動風格 / 偏好觀察\n'
        f'        - 近期對話彙整 — 細節脈絡\n'
        f'        - 偏好觀察 / 親密度 / 互動次數\n\n'
        f'      使用規則:\n'
        f'      1. 當對話提到某位觀眾 (被問 X 是怎樣的人 / 還記得 X 嗎 / 跟 X 聊過什麼 /\n'
        f'         想 callback 某人經驗 / 別人提到某 viewer), **請主動引用這份資料具體回答**:\n'
        f'         - 引用對話 highlight 的具體例子 (不只說名字)\n'
        f'         - 引用反思段落的觀察 (個性 / 偏好 / 互動風格)\n'
        f'         - 引用近期對話彙整的細節脈絡\n'
        f'      2. 引用時要**明確讓對方知道這是查資料得來的, 不是腦中鮮明記憶**.\n'
        f'         用什麼具體說法表達由你依當下角色狀態自然決定 (不限定措辭, 不要照抄範例).\n'
        f'         核心: 對方要能感受到「你有去找資料 + 找到了」, 而非「假裝都記得」.\n'
        f'      3. 不要假裝這些細節是腦中突然想起的 (誠實 = 信譽).\n'
        f'      4. 朋友卡跟現在對話無關時 (沒人提朋友), 照常聊, 別硬扯朋友資料.\n'
        f'    </retrieval_policy>\n'
        f'    <![CDATA[\n'
